...
// this is upcoming list page 
class BidderUpcomingListPage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            upcomingAuctionList: [],
    ...
    socketConnection = async () => {
        ...
        socketServices.on('aution_creation_response_for_bidder', async (data) => {
            this.onRefresh()
    ...
    _onUpcomingDetails = (item, key) => {
        this.props.navigation.navigate("BidderListDetails", { data: item, status: 4, key: key.toString().length > 1 ? key + 1 : "0" + (key + 1) });
                    ...
                    <View style={styles.BoxMarginSec}>
                        ...
                        <View style={styles.dateSec}>
                            <View style={styles.dateSubSec}>
                                ...
                                <View style={styles.startEndDateSec}>
    ...
    // this is main rener to this page 
    render() {
        return (
...
export default connect(mapStateToProps, mapDispatchToProps)(BidderUpcomingListPage);
