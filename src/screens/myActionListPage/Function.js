    ...
    if (auctionList && auctionList.length > 0) {
      for (let i = 0; i < auctionList.length; i++) {
        ...
        for (let j = 0; j < auctionList[i].length; j++) {
          ...
          if (
            auctionList[i][j].auctionfieldsvalueheaderid == undefined ||
            auctionList[i][j].auctionfieldsvalueheaderid == null
          ) {
            modObj["auctionfieldsvalueheaderid"] = "";
          } else {
            modObj["auctionfieldsvalueheaderid"] =
              auctionList[i][j].auctionfieldsvalueheaderid;
          }
          // check data entitytypeid
          if (
            auctionList[i][j].entitytypeid == undefined ||
            auctionList[i][j].entitytypeid == null
          ) {
            modObj["entitytypeid"] = "";
          } else {
          ...
          if (
            auctionList[i][j].fieldvalue == undefined ||
            auctionList[i][j].fieldvalue == null
          ) {
            modObj["fieldvalue"] = "";
          } else {
          ...
          if (
            auctionList[i][j].primefield == undefined ||
            auctionList[i][j].primefield == null
          ) {
            modObj["primefield"] = "";
          } else {
          ...
          if (
            auctionList[i][j].fielddesc == undefined ||
            auctionList[i][j].fielddesc == null
          ) {
            modObj["fielddesc"] = "";
          } else {
          ...
          if (
            auctionList[i][j].fieldlabeldesc == undefined ||
            auctionList[i][j].fieldlabeldesc == null
          ) {
          ...
          if (
            auctionList[i][j].primefieldlable == undefined ||
            auctionList[i][j].primefieldlable == null
          ) {
          ...
          if (
            auctionList[i][j].primefieldtype == undefined ||
            auctionList[i][j].primefieldtype == null
          ) {
          ...
          if (
            auctionList[i][j].primevalue == undefined ||
            auctionList[i][j].primevalue == null
          ) {
            modObj["primevalue"] = "";
          } else {
            modObj["primevalue"] = auctionList[i][j].primevalue;
          }
          // check data eventname
          if (
            auctionList[i][j].eventname == undefined ||
            auctionList[i][j].eventname == null
          ) {
            modObj["eventname"] = "";
          } else {
            modObj["eventname"] = auctionList[i][j].eventname;
          }
          // check data eventid
          if (
            auctionList[i][j].eventid == undefined ||
            auctionList[i][j].eventid == null
          ) {
            modObj["eventid"] = "";
          } else {
            modObj["eventid"] = auctionList[i][j].eventid;
          }
          // check data level
          if (
            auctionList[i][j].level == undefined ||
            auctionList[i][j].level == null
          ) {
            modObj["level"] = "";
          } else {
            modObj["level"] = auctionList[i][j].level;
          }
          // check data maptemplateeventlevelroleid
          if (
            auctionList[i][j].maptemplateeventlevelroleid == undefined ||
            auctionList[i][j].maptemplateeventlevelroleid == null
          ) {
            modObj["maptemplateeventlevelroleid"] = "";
          } else {
            modObj["maptemplateeventlevelroleid"] =
              auctionList[i][j].maptemplateeventlevelroleid;
          }
          ...
          if (
            auctionList[i][j].fieldlabeldesc == "Actual Auction End Date & Time"
          ) {
