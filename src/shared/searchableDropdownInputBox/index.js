...
function SearchableDropdownInputBox({
    height,
    selectedText,
    selectedTextColor,
    unSelectedTextColor,
        ...
        <>
            <TouchableOpacity style={[inputBoxStyle, additionalBoxStyle]} onPress={() => onOpenAndCloseModal()} activeOpacity={0.9}>
                ...
                <View style={{ marginRight: 16, alignItems: 'center', justifyContent: 'center' }}>
                    <Image style={[{ height: 12, width: 12, resizeMode: 'contain' }, upDownImgStyle]} source={modalVisible ? upDownImages[0] : upDownImages[1]} />
                </View>
            </TouchableOpacity>
...
SearchableDropdownInputBox.defaultProps = {
    isHidden: false,
    height: 45,
    selectedText: "",
    ...
    data: [],
    upDownImages: [
        ImageName.BLACK_UP_LOGO,
        ImageName.BLACK_DOWN_LOGO
    ],
    upDownImgStyle: {},
    isDisabled: false,
    onSelect: () => { },
    ...
    backgroundColor: Color.COLOR.GRAY.TRIPLET,
    fetchMore: () => { },
...
SearchableDropdownInputBox.propTypes = {
...
export default SearchableDropdownInputBox;